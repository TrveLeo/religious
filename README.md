...
Quatro fluxos, em horários diferentes:
...
- **Secundário** (`post-game.yml`, 15:00 BRT): alterna por dia entre 5 tipos de conteúdo (dia do ano % 5): Termo sendo revelado letra por letra, tabuleiro de Conexões sem revelar grupos, card de citação minimalista, trivia bíblica (pergunta + gabarito), e card de transparência sobre doações. Todos terminam com o card de doação.
